...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String loginSatus = sharedPreferences.getString(getResources().getString(R.string.prefLoginState),"");
        if (loginSatus.equals("loggedin")){
    ...
    private void login(final String email, final String password){
        ...
        progressDialog.show();
        String URL ="http://192.168.0.5/registerlogin/login.php";
